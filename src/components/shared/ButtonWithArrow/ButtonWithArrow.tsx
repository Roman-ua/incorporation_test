...
import arrow from '../../../images/shared/rightArrow.png';
...
const ButtonWithArrow = () => {
  return (
    ...
    <button className="relative inline-flex rounded-md bg-mainBlue items-center justify-start py-2.5 pl-4 pr-7 overflow-hidden font-semibold transition-all duration-150 ease-in-out group hover:bg-sideBarBlue">
      <span className="text-sm font-semibold text-white relative w-full text-left transition-colors duration-200 ease-in-out">
        Next Step
      </span>
      <img
        className="w-4 translate-x-2 group-hover:translate-x-3 transition-all duration-200 ease-in-out"
        src={arrow}
        alt="arrow"
      />
    </button>
