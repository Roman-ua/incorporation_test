...
import { Mail, FileText, LayoutDashboard, Users, ClipboardList, ConciergeBell, ChevronRight } from 'lucide-react';
  ...
  return (
    <div 
     className={classNames(
      ...
      <SecondPart path={label} value={companyData?.companyName} />
    </div>
  );
}
