  ...
  return (
    <div className="mb-6">
      ...
      <Datepicker
        ...
        inputClassName={
          'relative outline-0 block w-full rounded-md border-0 px-4 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-mainBlue sm:text-sm sm:leading-6'
        }
        toggleClassName={
