      ...
      >
        ...
        <div className="mt-1 relative">
          <input
            ...
            id={id}
            className={classNames(
              'bg-inputBackground outline-0 block w-full text-md rounded-md font-bold border-0 py-2 px-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-300 focus:ring-2 focus:ring-inset focus:ring-mainBlue focus:bg-white max-sm:text-sm sm:leading-6 hover:cursor-pointer',
