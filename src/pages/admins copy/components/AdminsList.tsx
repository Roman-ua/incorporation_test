...
import { AdminsPreloader2 } from './AdminsPreloader';
  ...
  return (
    <>
      ...
      {workspacesState.list.length ? (
        <div className="w-full overflow-hidden mb-12 container max-w-7xl mx-auto pl-10 pr-10 pb-8 pt-3 text-sm">
          <div>
            <div
